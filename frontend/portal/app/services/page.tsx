...
const SERVICES: { icon: IconKey; title: string; duration: string; desc: string; tags: string[]; accent: string }[] = [
  ...
  { icon: 'building', title: 'Multi-Tenant HR Portal', duration: 'Always-on · Per company', desc: 'Each client company gets a fully isolated HR portal. Upload candidates, schedule assessments, track live sessions, and access published reports — all within your own tenant. No cross-company data leakage, ever.', tags: ['Tenant isolation', 'Candidate upload', 'Live tracking', 'Report access'], accent: '#3B82F6' },
    ...
    <div style={{ minHeight: '100vh', background: '#040814', fontFamily: 'var(--font-ui)', overflowX: 'hidden' }}>
      ...
      <header style={{ position: 'relative', padding: '120px 24px 100px', textAlign: 'center', overflow: 'hidden' }} className="web-grid-bg">
        ...
        <Reveal style={{ position: 'relative', maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '18px', color: '#94A3B8', lineHeight: 1.75, margin: '0 auto', maxWidth: '600px' }}>
      ...
      <section style={{ background: 'rgba(255,255,255,0.015)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', padding: '100px 24px' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <Reveal style={{ textAlign: 'center', marginBottom: '64px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(32px,5vw,44px)', fontWeight: 800, color: '#F1F5F9', margin: '0 0 16px', letterSpacing: '-0.02em' }}>Assessment Types Available</h2>
              ...
              <Reveal key={at.cat} delay={(i % 3) * 50}>
                <div className="web-card" style={{ padding: '24px', height: '100%' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '10px', gap: 8 }}>
                    <h3 style={{ margin: 0, fontSize: '14px', fontWeight: 700, color: '#E2E8F0' }}>{at.cat}</h3>
                    <span style={{ fontSize: '11px', fontWeight: 700, color: '#3B82F6', background: 'rgba(59,130,246,0.1)', padding: '2px 8px', borderRadius: '9999px', whiteSpace: 'nowrap' }}>{at.count} roles</span>
                  </div>
      ...
      <section style={{ padding: '100px 24px', maxWidth: '1000px', margin: '0 auto' }}>
        <Reveal style={{ textAlign: 'center', marginBottom: '56px' }}>
          ...
          <h2 style={{ fontSize: 'clamp(28px,4vw,40px)', fontWeight: 800, color: '#F1F5F9', margin: 0, letterSpacing: '-0.02em' }}>assessexpert vs. Generic Platforms</h2>
        </Reveal>
        <Reveal>
          <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '16px', overflow: 'hidden' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 120px 120px', background: 'rgba(59,130,246,0.08)', padding: '16px 24px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
      ...
      {/* CTA */}
      <section style={{ padding: '100px 24px', textAlign: 'center', background: 'rgba(255,255,255,0.015)', borderTop: '1px solid rgba(59,130,246,0.1)' }}>
        <Reveal style={{ maxWidth: '600px', margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(28px,4vw,40px)', fontWeight: 800, color: '#F1F5F9', margin: '0 0 16px', letterSpacing: '-0.02em' }}>Need a custom assessment type?</h2>
