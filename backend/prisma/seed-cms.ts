...
async function main() {
  ...
  for (const [slug, m] of Object.entries({
    ...
    manpower: { title: 'Manpower', metaTitle: 'Skilled Manpower Supply - Engineers, Draftsmen, BIM Modellers | AssessExpert', metaDescription: 'Skilled manpower supply across the UAE and GCC - engineers, architects, CAD draftsmen, BIM modellers, quantity surveyors, and project managers. Every candidate pre-assessed on the AssessExpert platform.', content: { heroBadge: 'Skilled Manpower Supply', heroTitle: 'Engineering, Design &', heroHighlight: 'Construction Talent', heroSubtitle: 'Contract and permanent placement of pre-assessed engineers, draftsmen, designers, BIM modellers, and construction professionals across the UAE and wider GCC. Every CV comes with a proctored technical assessment score.', ctaTitle: 'Need talent this week?', ctaSubtitle: 'Share a role brief and receive a 3-5 candidate shortlist inside 5 business days, each with a verified assessment score attached.' } },
  })) {
    await prisma.cmsPage.upsert({
      where: { slug },
      update: {},
  ...
  console.log('  CMS pages: home, about, services, contact, blog, manpower');
